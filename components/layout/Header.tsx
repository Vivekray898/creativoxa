...
export default function Header() {
  ...
  // Close menus when navigation happens — adjusting state during render is
  // React's documented pattern for derived-state resets.
  ...
  // Scroll state — subscribing to an external system (scroll position).
  useLayoutEffect(() => {
